...
(function ($) {
  ...
  ($window.on("scroll", function () {
    ...
    $(".scroll-to-top").on("click", function (o) {
  ...
  $(document).ready(function () {
    ($(".testimonial-carousel1").owlCarousel({
      ...
      $(".slider-fade1").on("changed.owl.carousel", function (e) {
        e = e.item.index - 2;
      ...
      $(".slider-fade2").on("changed.owl.carousel", function (e) {
        e = e.item.index - 2;
        ($("h1").removeClass("animated fadeInUp"),
          $("a").removeClass("animated fadeInUp"),
          $(".owl-item")
